...
(function(f) {
    ...
    module.exports = f) : "function" === typeof define && define.amd ? define("highcharts/highcharts-more", ["highcharts"], function(C) {
        f(C);
        f.Highcharts = C;
        return f
    ...
    C(f, "parts-more/Pane.js", [f["parts/Chart.js"], f["parts/Globals.js"], f["parts/Pointer.js"], f["parts/Utilities.js"]], function(f, a, b, e) {
        ...
        e = function() {
            ...
            l.prototype.render = function() {
                ...
                if (c)
                    for (c = z(c),
                    l = Math.max(c.length, this.background.length || 0),
                    a = 0; a < l; a++)
                        c[a] && this.axis ? this.renderBackground(x(this.defaultBackgroundOptions, c[a]), a) : this.background[a] && (this.background[a] = this.background[a].destroy(),
        ...
        q(b, "beforeGetHoverData", function(l) {
            var c = this.chart;
            c.polar && (c.hoverPane = c.getHoverPane(l),
            l.filter = function(a) {
        ...
        e = function() {
            ...
            a.init = function(a) {
                ...
                a.getLinePath = function(m, n, d) {
                    ...
                    n.xBounds = [this.left + m[0]],
                    n.yBounds = [this.top + m[1] - k]) : (n = this.postTranslate(this.angleRad, k),
                ...
                a.getPlotBandPath = function(m, n, d) {
                    ...
                    if ("polygon" === this.options.gridLineInterpolation)
                        ...
                        l && (l = (u + d) / 2,
                        p = this.left + k[0] + k[2] / 2 * Math.cos(l),
                        r.xBounds = l > -Math.PI / 2 && l < Math.PI / 2 ? [p, this.chart.plotWidth] : [0, p],
                        r.yBounds = [this.top + k[1] + k[2] / 2 * Math.sin(l)],
                        r.yBounds[0] += l > -Math.PI && 0 > l || l > Math.PI ? -10 : 10)
                    }
                    return r
                }
                ;
                a.getCrosshairPosition = function(m, n, d) {
                    ...
                    if (this.isCircular) {
                        if (t(g))
                            m.point && (u = m.point.shapeArgs || {},
                            u.start && (g = this.chart.inverted ? this.translate(m.point.rectPlotY, !0) : m.point.x));
                        else {
                            var u = m.chartX || 0;
                            var A = m.chartY || 0;
                        ...
                        t(g) || (u = m.chartX,
                        A = m.chartY),
                        t(u) && t(A) && (d = k[1] + this.chart.plotTop,
                ...
                a.getPlotLinePath = function(m) {
                    ...
                    r = d[3] / 2;
                    var q;
                    m.isCrosshair && (b = this.getCrosshairPosition(m, c, p),
                    u = b[0],
                    e = b[1],
                    b = b[2]);
                    if (n.isCircular)
                        u = Math.sqrt(Math.pow(e - c, 2) + Math.pow(b - p, 2)),
                        A = "string" === typeof a ? l(a, 1) : a / u,
                        g = "string" === typeof h ? l(h, 1) : h / u,
                        d && r && (u = r / u,
                        A < u && (A = u),
                        g < u && (g = u)),
                        d = [["M", c + A * (e - c), p - A * (p - b)], ["L", e - (1 - g) * (e - c), b + (1 - g) * (p - b)]];
                    else if ((u = n.translate(u)) && (0 > u || u > w) && (u = 0),
                    "circle" === n.options.gridLineInterpolation)
                        d = n.getLinePath(0, u, r);
                    else if (d = [],
                    g[k ? "yAxis" : "xAxis"].forEach(function(d) {
                        d.pane === n.pane && (q = d)
                    }),
                    q)
                        for (c = q.tickPositions,
                        q.autoConnect && (c = c.concat([c[0]])),
                        A && (c = c.slice().reverse()),
                        u && (u += r),
                        e = 0; e < c.length; e++)
                            p = q.getPosition(c[e], u),
                            d.push(e ? ["L", p.x, p.y] : ["M", p.x, p.y]);
                    return d
                }
                ;
                ...
                a.createLabelCollector = function() {
                    ...
                    return function() {
                        if (c.isRadial && c.tickPositions && !0 !== c.options.labels.allowOverlap)
                            return c.tickPositions.map(function(n) {
            ...
            a.compose = function(p, e) {
                h(p, "init", function(c) {
                    ...
                    if ("colorAxis" === A)
                        ...
                        if (g) {
                            if (r ? b.init(this) : a.init(this),
                            l = !u)
                                this.defaultPolarOptions = a.defaultRadialGaugeOptions
                        } else
                            k && (a.init(this),
                            this.defaultPolarOptions = (l = this.horiz) ? a.defaultCircularOptions : z("xAxis" === A ? p.defaultOptions : p.defaultYAxisOptions, a.defaultRadialOptions),
                ...
                h(p, "afterInit", function() {
                    ...
                    this.endAngleRad = (c(g.endAngle, g.startAngle + 360) - 90) * Math.PI / 180,
                    ...
                    if (d) {
                        ...
                        if (n.isRadial) {
                            ...
                            if ("auto" === r && 2 === n.tickPositions.length && n.isCircular) {
                                ...
                                180 < b && 360 >= b && (b = 360 - b);
                                if (n.pane.options.startAngle === p || n.pane.options.startAngle === p + 360 || n.pane.options.startAngle === p - 360)
                                    h = "start";
                ...
                w(e.prototype, "getMarkPath", function(c, n, d, g, k, u, A) {
                    var r = this.axis;
                    r.isRadial ? (c = r.getPosition(this.pos, r.center[2] / 2 + g),
                    n = ["M", n, d, "L", c.x, c.y]) : n = c.call(this, n, d, g, k, u, A);
                    return n
                })
            }
            ;
        ...
        b("arearange", "area", {
            ...
            translate: function() {
                ...
                c.points.forEach(function(l) {
                    var e = l.high
                      , m = l.plotY;
                    l.isNull ? l.plotY = null : (l.plotLow = m,
                    l.plotHigh = a.translate(p ? c.modifyValue(e, l) : e, 0, 1, 0, 1),
            ...
            drawDataLabels: function() {
                ...
                if (g.enabled || this._hasPointLabels) {
                    for (e = a; e--; )
                        if (m = c[e])
                            k = g.inside ? m.plotHigh < m.plotLow : m.plotHigh > m.plotLow,
                            m.below = !k,
                            n ? g.align || (g.align = k ? "left" : "right") : g.verticalAlign || (g.verticalAlign = k ? "bottom" : "top");
                ...
                if (d.enabled)
                    for (e = a; e--; )
                        if (m = c[e])
                            m.dataLabels = [m.dataLabelUpper, m.dataLabel].filter(function(d) {
                                return !!d
                            });
            ...
            drawPoints: function() {
                ...
                for (a = 0; a < c; )
                    b = this.points[a],
                    b.upperGraphic = b.graphic,
                    b.graphic = b.lowerGraphic,
                    h(b, b.origProps),
                    delete b.origProps,
                    a++
            },
            ...
            setState: function() {
                ...
                b.stateMarkerGraphic && (b.lowerStateMarkerGraphic = b.stateMarkerGraphic,
                ...
                b.stateMarkerGraphic && (b.upperStateMarkerGraphic = b.stateMarkerGraphic,
        ...
        b("columnrange", "arearange", h(a.plotOptions.column, a.plotOptions.arearange, {
            ...
            translate: function() {
                ...
                a.points.forEach(function(n) {
                    ...
                    f ? (h = n.barX + l,
                    n.shapeType = "arc",
                    n.shapeArgs = a.polarArc(k + u, k, h, h + n.pointWidth)) : (d.height = u,
                    d.y = k,
                    n.tooltipPos = p.inverted ? [b.len + b.pos - p.plotLeft - k - u / 2, c.len + c.pos - p.plotTop - d.x - d.width / 2, u] : [c.left - p.plotLeft + d.x + d.width / 2, b.pos - p.plotTop + k + u / 2, u])
                })
            },
            directTouch: !0,
        ...
        a("gauge", "line", {
            ...
            translate: function() {
                ...
                this.points.forEach(function(f) {
                    ...
                    if (e(g) || !1 === c.wrap)
                        g = e(g) ? g / 180 * Math.PI : 0,
                        k = b(k, a.startAngleRad - g, a.endAngleRad + g);
                    k = 180 * k / Math.PI;
                    f.shapeType = "path";
                    f.shapeArgs = {
            ...
            drawPoints: function() {
                ...
                a.points.forEach(function(b) {
                    var n = b.graphic
                      ...
                      , k = h(f.dial, b.dial);
                    n ? (n.animate(d),
                    d.d = g) : b.graphic = v[b.shapeType](d).attr({
                        rotation: d.rotation,
                        zIndex: 1
                    }).addClass("highcharts-dial").add(a.group);
                    if (!c.styledMode)
                        b.graphic[n ? "animate" : "attr"]({
                ...
                e ? e.animate({
                    ...
                    zIndex: 2
                }).addClass("highcharts-pivot").translate(b[0], b[1]).add(a.group),
                c.styledMode || a.pivot.attr({
            ...
            drawPoints: function() {
                ...
                a.points.forEach(function(r) {
                    var D = r.graphic
                      ...
                      , H = {}
                      , t = r.color || a.color;
                    "undefined" !== typeof r.plotY && (m = Math.round(q.width),
                    n = Math.floor(q.x),
                    d = n + m,
                    g = Math.round(m / 2),
                    z = Math.floor(k ? r.q1Plot : r.lowPlot),
                    c = Math.floor(k ? r.q3Plot : r.lowPlot),
                    l = Math.floor(r.highPlot),
                    w = Math.floor(r.lowPlot),
                    D || (r.graphic = D = f.g("point").add(a.group),
                    r.stem = f.path().addClass("highcharts-boxplot-stem").add(D),
                    A && (r.whiskers = f.path().addClass("highcharts-boxplot-whisker").add(D)),
                    k && (r.box = f.path(void 0).addClass("highcharts-boxplot-box").add(D)),
                    r.medianShape = f.path(void 0).addClass("highcharts-boxplot-median").add(D)),
                    h.styledMode || (E.stroke = r.stemColor || e.stemColor || t,
                    E["stroke-width"] = b(r.stemWidth, e.stemWidth, e.lineWidth),
                    E.dashstyle = r.stemDashStyle || e.stemDashStyle || e.dashStyle,
                    r.stem.attr(E),
                    A && (F.stroke = r.whiskerColor || e.whiskerColor || t,
                    F["stroke-width"] = b(r.whiskerWidth, e.whiskerWidth, e.lineWidth),
                    F.dashstyle = r.whiskerDashStyle || e.whiskerDashStyle || e.dashStyle,
                    r.whiskers.attr(F)),
                    k && (G.fill = r.fillColor || e.fillColor || t,
                    G.stroke = e.lineColor || t,
                    G["stroke-width"] = e.lineWidth || 0,
                    G.dashstyle = r.boxDashStyle || e.boxDashStyle || e.dashStyle,
                    r.box.attr(G)),
                    H.stroke = r.medianColor || e.medianColor || t,
                    H["stroke-width"] = b(r.medianWidth, e.medianWidth, e.lineWidth),
                    H.dashstyle = r.medianDashStyle || e.medianDashStyle || e.dashStyle,
                    r.medianShape.attr(H)),
                    y = r.stem.strokeWidth() % 2 / 2,
                    v = n + g + y,
                    D = [["M", v, c], ["L", v, l], ["M", v, z], ["L", v, w]],
                    r.stem[I]({
                        d: D
                    }),
                    k && (y = r.box.strokeWidth() % 2 / 2,
                    z = Math.floor(z) + y,
                    c = Math.floor(c) + y,
                    n += y,
                    d += y,
                    D = [["M", n, c], ["L", n, z], ["L", d, z], ["L", d, c], ["L", n, c], ["Z"]],
                    r.box[I]({
                        d: D
                    })),
                    A && (y = r.whiskers.strokeWidth() % 2 / 2,
                    l += y,
                    w += y,
                    u = /%$/.test(A) ? g * parseFloat(A) / 100 : A / 2,
                    D = [["M", v - u, l], ["L", v + u, l], ["M", v - u, w], ["L", v + u, w]],
                    r.whiskers[I]({
                        d: D
                    })),
                    p = Math.round(r.medianPlot),
                    y = r.medianShape.strokeWidth() % 2 / 2,
                    p += y,
                    D = [["M", n, p], ["L", d, p]],
                    r.medianShape[I]({
                        d: D
        ...
        q("waterfall", "column", {
            ...
            generatePoints: function() {
                ...
                for (a = this.points.length; c < a; c++) {
                    ...
                    if (d.isIntermediateSum || d.isSum)
                        d.y = z(g)
                }
            },
            translate: function() {
                    ...
                    if (A) {
                        if (r) {
                            ...
                            if ("overlap" === A) {
                                ...
                                0 <= v ? (t = q.threshold + q.posTotal,
                                q.posTotal -= v) : (t = q.threshold + q.negTotal,
                                q.negTotal -= v,
                                t -= v),
                                !q.posTotal && Object.hasOwnProperty.call(q, "absolutePos") && (q.posTotal = q.absolutePos,
                                delete q.absolutePos),
                                !q.negTotal && Object.hasOwnProperty.call(q, "absoluteNeg") && (q.negTotal = q.absoluteNeg,
                                delete q.absoluteNeg);
                            h.isSum || (q.connectorThreshold = q.threshold + q.stackTotal);
                            c.reversed ? (f = 0 <= v ? t - v : t + v,
                            v = t) : (f = t,
                            v = t - v);
                            h.below = f <= w(u, 0);
                        ...
                        if (v = c.waterfall.dummyStackItem)
                            v.x = l,
                            v.label = r[l].label,
                            v.setOffset(this.pointXOffset || 0, this.barW || 0, this.stackedYNeg[l], this.stackedYPos[l])
                    } else
                        t = Math.max(b, b + v) + q[0],
                        p.y = c.translate(t, 0, 1, 0, 1),
                        h.isSum ? (p.y = c.translate(q[1], 0, 1, 0, 1),
                        ...
                        f ^= v),
                        p.y = c.translate(f, 0, 1, 0, 1),
                        p.height = Math.abs(p.y - Math.min(c.translate(v, 0, 1, 0, 1), c.len)),
                        d += q[1]) : (p.height = 0 < f ? c.translate(b, 0, 1, 0, 1) - p.y : c.translate(b, 0, 1, 0, 1) - c.translate(b - f, 0, 1, 0, 1),
                        b += f,
                        h.below = b < w(u, 0)),
                        0 > p.height && (p.y += p.height,
                        p.height *= -1);
                    h.plotY = p.y = Math.round(p.y) - this.borderWidth % 2 / 2;
                    p.height = Math.max(Math.round(p.height), .001);
                    h.yBottom = p.y + p.height;
                    p.height <= g && !h.isNull ? (p.height = g,
                    p.y -= k,
                    h.plotY = p.y,
                    h.minPointLengthOffset = 0 > h.y ? -k : k) : (h.isNull && (p.width = 0),
            ...
            setStackedPoints: function() {
                ...
                if (this.visible || !this.chart.options.chart.ignoreHiddenSeries) {
                    ...
                    for (var v = 0; v < e; v++) {
                        ...
                        z && z.isIntermediateSum ? (c(f, l, 0, f),
                        f = l,
                        l = g,
                        k ^= u,
                        u ^= k,
                        k ^= u) : z && z.isSum ? (c(g, p, B),
                        k = g) : (c(k, y, 0, p),
                        z && (p += y,
                        l += y));
                        w.stateIndex++;
    ...
    C(f, "parts-more/BubbleLegend.js", [f["parts/Chart.js"], f["parts/Color.js"], f["parts/Globals.js"], f["parts/Legend.js"], f["parts/Utilities.js"]], function(f, a, b, e, h) {
        ...
        w = function() {
            ...
            a.prototype.drawLegendSymbol = function(d) {
                ...
                this.setOptions(),
                this.render(),
                g = this.getMaxLabelSize(),
                c = this.ranges[0].radius,
                d = 2 * c,
                r = r - c + g.width,
                r = 0 < r ? r : 0,
                this.maxLabel = g,
                this.movementX = "left" === k.labels.align ? r : 0,
                this.legendItemWidth = d + r + a,
            ...
            a.prototype.setOptions = function() {
                ...
                d.forEach(function(u, A) {
                    h || (a.stroke = l(u.borderColor, g.borderColor, k.color),
                    a.fill = l(u.color, g.color, 1 !== e ? q(k.color).setOpacity(e).get("rgba") : k.color),
            ...
            a.prototype.renderRange = function(d) {
                ...
                var m = a.styledMode;
                "center" === l && (h = 0,
                g.connectorDistance = 0,
                d.labelStyle.align = "center");
                l = p + g.labels.y;
            ...
            a.prototype.hideOverlappingLabels = function() {
                var d = this.chart
                  , g = this.symbols;
                !this.options.labels.allowOverlap && g && (d.hideOverlappingLabels(g.labels),
                g.labels.forEach(function(d, a) {
            ...
            a.prototype.getRanges = function() {
                ...
                d.chart.series.forEach(function(d) {
                    d.isBubble && !d.ignoreSeries && (k = d.zData.filter(B),
                    k.length && (a = l(d.options.zMin, Math.min(a, Math.max(x(k), !1 === d.options.displayNegative ? d.options.zThreshold : -Number.MAX_VALUE))),
            ...
            a.prototype.predictBubbleSizes = function() {
                ...
                h = h.options.maxSize;
                var n = Math.min(e, b);
                if (k.floating || !/%$/.test(h))
                    g = l;
                else if (h = parseFloat(h),
                g = (n + c - g.h / 2) * h / 100 / (h / 100 + 1),
                a && e - g >= b || !a && b - g >= e)
                    g = l;
        ...
        a(e, "afterGetAllItems", function(a) {
            ...
            this.destroyItem(d));
            0 <= c && g.enabled && k.enabled && (k.seriesIndex = c,
            this.bubbleLegend = new b.BubbleLegend(k,this),
        ...
        f.prototype.getVisibleBubbleSeriesIndex = function() {
            for (var a = this.series, d = 0; d < a.length; ) {
                if (a[d] && a[d].isBubble && a[d].visible && a[d].zData.length)
                    return d;
                d++
            }
            return -1
        ...
        e.prototype.getLinesHeights = function() {
            ...
            for (k = 0; k < g; k++)
                if (a[k].legendItemHeight && (a[k].itemHeight = a[k].legendItemHeight),
        ...
        e.prototype.retranslateItems = function(a) {
            ...
            this.allItems.forEach(function(r, e) {
                ...
                if ((k = r.movementX) || c && r.ranges)
                    k = c ? d - r.options.maxSize / 2 : d + k,
                    r.legendGroup.attr({
                        translateX: k
                    });
                e > a[b].step && b++;
        ...
        a(v, "legendItemClick", function() {
            var a = this.chart
              , d = this.visible
              , g = this.chart.legend;
            g && g.bubbleLegend && (this.visible = !d,
            this.ignoreSeries = d,
        ...
        y(f.prototype, "drawChartBox", function(a, d, g) {
            ...
            if (k && k.options.enabled && k.bubbleLegend && k.options.bubbleLegend.autoRanges && b) {
                ...
                e.placed || (k.group.placed = !1,
                k.allItems.forEach(function(d) {
    ...
    C(f, "parts-more/BubbleSeries.js", [f["parts/Globals.js"], f["parts/Color.js"], f["parts/Point.js"], f["parts/Utilities.js"]], function(f, a, b, e) {
        ...
        a("bubble", "scatter", {
            ...
            getRadius: function(a, c, b, d, g, k) {
                ...
                if (null === k || null === g)
                    return null;
                if (z(g)) {
                    e.sizeByAbsoluteValue && (g = Math.abs(g - r),
                    l = Math.max(c - r, Math.abs(a - r)),
                    a = 0);
                    if (g < a)
                        return b / 2 - 1;
                    0 < l && (f = (g - a) / l)
        ...
        e.prototype.beforePadding = function() {
            ...
            this.series.forEach(function(d) {
                ...
                F.push(d),
                k && (["minSize", "maxSize"].forEach(function(d) {
                    var a = g[d]
                      , c = /%$/.test(a);
                    a = l(a);
                    r[d] = c ? p * a / 100 : a
                }),
                d.minPxSize = r.minSize,
                d.maxPxSize = Math.max(r.maxSize, r.minSize),
                d = d.zData.filter(z),
            ...
            F.length && 0 < B && !this.logarithmic && (g -= b,
            E *= (b + Math.max(0, d) - Math.min(g, b)) / b,
        ...
        f.networkgraphIntegrations = {
            verlet: {
                ...
                attractive: function(a, b, e) {
                    ...
                    a.toNode.fixedPosition || (a.toNode.plotX += f * h.toNode / a.toNode.degree,
                    a.toNode.plotY += b * h.toNode / a.toNode.degree)
                },
            ...
            euler: {
                ...
                attractive: function(a, b, e, h) {
                    ...
                    a.toNode.fixedPosition || (a.toNode.dispX += t * f.toNode / a.toNode.degree,
    ...
    C(f, "modules/networkgraph/QuadTree.js", [f["parts/Globals.js"], f["parts/Utilities.js"]], function(f, a) {
        ...
        a(b.prototype, {
            insert: function(a, h) {
                ...
                this.body ? h ? (this.isInternal = !0,
                this.divideBox(),
                !0 !== this.body && (this.nodes[this.getBoxPosition(this.body)].insert(this.body, h - 1),
                this.body = !0),
                this.nodes[this.getBoxPosition(a)].insert(a, h - 1)) : (h = new b({
                    top: a.plotX,
                    left: a.plotY,
                    width: .1,
                    height: .1
                ...
                h.body = a,
                h.isInternal = !1,
                this.nodes.push(h)) : (this.isInternal = !1,
                this.body = a))
            },
            updateMassAndCenter: function() {
                ...
                b /= a,
                f /= a) : this.body && (a = this.body.mass,
                b = this.body.plotX,
                f = this.body.plotY);
                this.mass = a;
                this.plotX = b;
        ...
        t(a.layouts["reingold-fruchterman"].prototype, {
            ...
            step: function() {
                var c = this
                  , b = this.series;
                c.currentStep++;
                "barnes-hut" === c.approximation && (c.createQuadTree(),
                c.quadTree.calculateMassAndCenter());
            ...
            barnesHutApproximation: function(a, b) {
                ...
                if (a !== b && 0 !== e)
                    if (b.isInternal)
                        ...
                        f = this.repulsiveForce(e, this.k),
                        this.force("repulsive", a, f * b.mass, c, e);
                return h
            },
            ...
            attractiveForces: function() {
                ...
                a.links.forEach(function(c) {
                    c.fromNode && c.toNode && (b = a.getDistXY(c.fromNode, c.toNode),
                    e = a.vectorLength(b),
                    0 !== e && (f = a.attractiveForce(e, a.k),
                    a.force("attractive", c, f, b, e)))
                })
            },
            applyLimits: function() {
                var a = this;
                a.nodes.forEach(function(c) {
                    c.fixedPosition || (a.integration.integrate(a, c),
                    a.applyLimitBox(c, a.box),
                    c.dispX = 0,
                    c.dispY = 0)
                })
            },
        ...
        a.dragNodesMixin = {
            ...
            onMouseMove: function(a, b) {
                if (a.fixedPosition && a.inDragMode) {
                    ...
                    if (5 < Math.abs(f) || 5 < Math.abs(h))
                        f = a.fixedPosition.plotX - f,
                        h = a.fixedPosition.plotY - h,
                        e.isInsidePlot(f, h) && (a.plotX = f,
                        a.plotY = h,
                        a.hasDragged = !0,
                        this.redrawHalo(a),
        ...
        b.networkgraphIntegrations.packedbubble = {
            ...
            barycenter: function() {
                ...
                c.forEach(function(d) {
                    a.options.splitSeries && !d.isParentNode ? (e = d.series.parentNode.plotX,
                    f = d.series.parentNode.plotY) : (e = b.width / 2,
                    f = b.height / 2);
            ...
            repulsive: function(a, g, b, c) {
                ...
                g = b.x * d;
                b = b.y * d;
                a.fixedPosition || (a.plotX += g,
                a.plotY += b);
                c.fixedPosition || (c.plotX -= g,
                c.plotY -= b)
            },
        ...
        b.layouts.packedbubble = a(m, {
            ...
            setCircularPositions: function() {
                ...
                b.forEach(function(d, b) {
                    a.options.splitSeries && !d.isParentNode ? (e = d.series.parentNode.plotX,
                    f = d.series.parentNode.plotY) : (e = g.width / 2,
                    f = g.height / 2);
            ...
            repulsiveForces: function() {
                ...
                a.nodes.forEach(function(d) {
                    ...
                    a.nodes.forEach(function(k) {
                        ...
                        b = a.vectorLength(c) - (d.marker.radius + k.marker.radius + e),
                        0 > b && (d.degree += .01,
                        d.neighbours++,
                        g = a.repulsiveForce(-b / Math.sqrt(d.neighbours), a.k, d, k)),
            ...
            applyLimitBox: function(a) {
                if (this.options.splitSeries && !a.isParentNode && this.options.parentNodeLimit) {
                    ...
                    0 > b && b > -2 * a.marker.radius && (a.plotX -= .01 * d.x,
                    a.plotY -= .01 * d.y)
                }
        ...
        h("packedbubble", "bubble", {
            ...
            accumulateAllPoints: function(a) {
                ...
                for (c = 0; c < d.series.length; c++)
                    if (a = d.series[c],
                    a.is("packedbubble") && a.visible || !d.options.chart.ignoreHiddenSeries)
            ...
            setVisible: function() {
                ...
                a.parentNode.dataLabel && a.parentNode.dataLabel.show()) : (a.graph.hide(),
            ...
            seriesBox: function() {
                ...
                this.data.forEach(function(a) {
                    B(a.plotX) && B(a.plotY) && a.marker.radius && (e = a.marker.radius,
                    f[0] = c(f[0], a.plotX - e),
                    f[1] = b(f[1], a.plotX + e),
                    f[2] = c(f[2], a.plotY - e),
                    f[3] = b(f[3], a.plotY + e))
            ...
            createParentNodes: function() {
                ...
                a.parentNode && (f.plotX = a.parentNode.plotX,
            ...
            addSeriesLayout: function() {
                ...
                f || (g[a.type + "-series"] = f = new b.layouts[a.type],
                f.init(e),
            ...
            addLayout: function() {
                ...
                g || (this.chart.graphLayoutsStorage = g = {},
                this.chart.graphLayoutsLookup = c = []);
                var f = g[a.type];
                f || (a.enableSimulation = B(e.forExport) ? !e.forExport : a.enableSimulation,
                g[a.type] = f = new b.layouts[a.type],
                f.init(a),
                c.splice(f.index, 0, f));
                this.layout = f;
            ...
            translate: function() {
                ...
                for (e = 0; e < h.length; e++)
                    if (h[e][3] === k) {
                        var l = b[h[e][4]];
                        var m = h[e][2];
                        f || (l.plotX = h[e][0] - a.plotLeft + a.diffX,
                        l.plotY = h[e][1] - a.plotTop + a.diffY);
                        l.marker = z(l.marker, {
                            radius: m,
                            width: 2 * m,
                            height: 2 * m
            ...
            placeBubbles: function(a) {
                ...
                if (a.length) {
                    ...
                    if (1 < a.length)
                        for (c.push([[0, 0 - a[1][2] - a[0][2], a[1][2], a[1][3], a[1][4]]]),
                        m = 2; m < a.length; m++)
                            a[m][2] = a[m][2] || 1,
                            l = d(c[e][f], c[e - 1][h], a[m]),
                            b(l, c[e][0]) ? (c.push([]),
                            h = 0,
                            c[e + 1].push(d(c[e][f], c[e][0], a[m])),
                            e++,
                            f = 0) : 1 < e && c[e - 1][h + 1] && b(l, c[e - 1][h + 1]) ? (h++,
                            c[e].push(d(c[e][f], c[e - 1][h], a[m])),
                            f++) : (f++,
                            c[e].push(l));
                    this.chart.stages = c;
            ...
            resizeRadius: function() {
                ...
                if (1e-10 < Math.abs(c - 1)) {
                    ...
                    a.diffY = l / 2 + h - n - (p - n) / 2,
                    a.diffX = m / 2 + f - t - (v - t) / 2
            },
            ...
            onMouseUp: function(a) {
                if (a.fixedPosition && !a.removed) {
                    ...
                    e && d.options.dragBetweenSeries && e.nodes.forEach(function(g) {
                        a && a.marker && g !== a.series.parentNode && (b = d.getDistXY(a, g),
                        c = d.vectorLength(b) - g.marker.radius - a.marker.radius,
            ...
            select: function(a, c) {
                ...
                this.isParentNode ? (d.getSelectedPoints = d.getSelectedParentNodes,
    ...
    C(f, "parts-more/Polar.js", [f["parts/Chart.js"], f["parts/Globals.js"], f["parts-more/Pane.js"], f["parts/Pointer.js"], f["parts/SVGRenderer.js"], f["parts/Utilities.js"]], function(f, a, b, e, h, q) {
        ...
        n.toXY = function(a) {
            ...
            this.kdByAngle ? (b = (e / Math.PI * 180 + c.pane.options.startAngle) % 360,
            0 > b && (b += 360),
        ...
        var d = function(b, c) {
            ...
            if (e.polar)
                if (d.isRadialBar)
                    c || (d.startAngleRad = l(d.translatedThreshold, d.xAxis.startAngleRad),
        ...
        y(n, "animate", d);
        m.column && (v = m.arearange.prototype,
            ...
            if (f.isRadial) {
                ...
                for (; f--; ) {
                    ...
                    if (e.inverted) {
                        ...
                        if (d && g.stacking) {
                            if (y = g.stacking.stacks[(0 > y ? "-" : "") + this.stackKey],
                        ...
                        C = w + m,
                        b.shapeArgs = this.polarArc(b.yBottom, b.plotY, C, C + b.pointWidth);
                    this.toXY(b);
                    e.inverted ? (w = g.postTranslate(b.rectPlotY, w + b.pointWidth / 2),
                    b.tooltipPos = [w.x - e.plotLeft, w.y - e.plotTop]) : b.tooltipPos = [b.plotX, b.plotY];
        ...
        ,
        v && (v.findAlignments = m.findAlignments),
        y(m, "alignDataLabel", function(a, b, c, d, e, f) {
            var g = this.chart
              , h = l(d.inside, !!this.options.stacking);
            g.polar ? (a = b.rectPlotX / Math.PI * 180,
            g.inverted ? (this.forceDL = g.isInsidePlot(b.plotX, Math.round(b.plotY), !1),
            h && b.shapeArgs ? (e = b.shapeArgs,
            e = this.yAxis.postTranslate((e.start + e.end) / 2 - this.xAxis.startAngleRad, b.barX + b.pointWidth / 2),
            e = {
                x: e.x - g.plotLeft,
                y: e.y - g.plotTop
            }) : b.tooltipPos && (e = {
            ...
            d.align = l(d.align, "center"),
            d.verticalAlign = l(d.verticalAlign, "middle")) : this.findAlignments && (d = this.findAlignments(a, d)),
            n.alignDataLabel.call(this, b, c, d, e, f),
            this.isRadialBar && b.shapeArgs && b.shapeArgs.start === b.shapeArgs.end && c.hide(!0)) : a.call(this, b, c, d, e, f)
        }));
        ...
        t(a.Series, "afterInit", function() {
            var a = this.chart;
            a.inverted && a.polar && (this.isRadialSeries = !0,
