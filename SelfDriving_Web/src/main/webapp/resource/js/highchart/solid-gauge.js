(function(a) {
    ...
    module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/solid-gauge", ["highcharts", "highcharts/highcharts-more"], function(g) {
        a(g);
        a.Highcharts = g;
        return a
    ...
    g(a, "modules/solid-gauge.src.js", [a["parts/Color.js"], a["parts/Globals.js"], a["mixins/legend-symbol.js"], a["parts/Utilities.js"]], function(a, g, x, c) {
        ...
        c(g.Renderer.prototype.symbols, "arc", function(e, a, l, b, z, d) {
            e = e(a, l, b, z, d);
            d.rounded && (b = ((d.r || b) - (d.innerR || 0)) / 2,
            a = e[0],
            d = e[2],
            "M" === a[0] && "L" === d[0] && (a = ["A", b, b, 0, 1, 1, a[1], a[2]],
        ...
        (function(a) {
            var e = {
                initDataClasses: function(a) {
                    var e = this.chart, l, d = 0, h = this.options;
                    this.dataClasses = l = [];
                    a.dataClasses.forEach(function(b, f) {
                        b = y(b);
                        l.push(b);
                        b.color || ("category" === h.dataClassColor ? (f = e.options.colors,
                        b.color = f[d++],
                        d === f.length && (d = 0)) : b.color = k(h.minColor).tweenTo(k(h.maxColor), f / (a.dataClasses.length - 1)))
                    })
                },
                ...
                toColor: function(a, e) {
                    var b = this.stops, d = this.dataClasses, h;
                    if (d)
                        for (h = d.length; h--; ) {
                            var c = d[h];
                            var f = c.from;
        ...
        a("solidgauge", "gauge", {
            ...
            drawPoints: function() {
                var a = this, c = a.yAxis, g = c.center, b = a.options, m = a.chart.renderer, d = b.overshoot, h = v(d) ? d / 180 * Math.PI : 0, k;
                ...
                a.points.forEach(function(f) {
                    if (!f.isNull) {
                        ...
                        k && (n.d = k)) : f.graphic = d = m.arc(n).attr({
                            fill: p,
                            "sweep-flag": 0
                        }).add(a.group);
            ...
            animate: function(a) {
                a || (this.startAngleRad = this.thresholdAngleRad,
