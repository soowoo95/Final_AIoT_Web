...
<html>
	...
	<script>
			...
			function sendJet(data) {
				...
				client.send(message);
				console.log(orderData.zone +"에서 발생한  사건 JETRACER에게 보냄");
		...
		<div class="d-flex align-items-stretch" style="height: 875px;">
			<nav id="sidebar" style="height: 1030px;">
				<div class="sidebar-header d-flex align-items-center">
					<div class="avatar" style="width: 100px; height: 100px; align-itself: center;">
						<img src="${pageContext.request.contextPath}/resource/img/milk.jpg" class="img-fluid rounded-circle">
					</div>
					<div class="title">
				...
				<ul class="list-unstyled">
					<li><a href="${pageContext.request.contextPath}/home/main.do" style="color: lightgray"> <i class="icon-home"></i>메인 페이지
					</a></li>
					<li><a href="${pageContext.request.contextPath}/home/jetson1.do" style="color: lightgray"> <i class="icon-writing-whiteboard"></i>탐지봇현황
					</a></li>
					<li><a href="${pageContext.request.contextPath}/home/history.do" style="color: lightgray"> <i class="icon-grid"></i>탐지 히스토리 조회
					</a></li>
					<li class="active"><a href="${pageContext.request.contextPath}/home/status.do" style="color: lightgray"> <i class="icon-padnote"></i>실시간 탐지 | 대응 현황
					</a></li>
					<li><a href="${pageContext.request.contextPath}/home/analysis.do" style="color: lightgray"> <i class="icon-chart"></i>탐지 결과 분석
					</a></li>
				</ul>
			</nav>
			...
			<div class="page-content"
				...
				<div style="margin-bottom: 10px; margin-top: 60px; color: white; font-weight: bold; font-size: xx-large; height: 50px; width: 1623px; text-align: center;">실시간
					유해동물 탐지 및 대응 현황</div>
							...
							<table class="table table-striped table-sm"
								...
								<thead style="border-style: double; border-left: hidden; border-right: hidden; border-top: hidden; border-color: #864DD9; font-size: medium;">
									<tr style="height: 40px; justify-content: center; padding: 0px; color: #864DD9; text-align: center;">
										...
										<th style="width: 40px; display: none">보이진 않겠지만 DNO 존재함!</th>
									</tr>
								</thead>
						...
						<table class="table hover" style="margin-bottom: 0px">
							...
							<tbody style="color: white; font-size: small;">
								<tr id="cctv1">
									...
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c1Obj" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c1Lev" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c1Loc" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
								</tr>
								<tr id="cctv2">
									<td id="c2Col1" style="text-align: center; width: 200px; padding-bottom: 0px; height: 48px;">CCTV 2</td>
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c2Obj" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c2Lev" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c2Loc" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
								</tr>
								<tr id="cctv3">
									<td id="c3Col1" style="text-align: center; width: 200px; padding-bottom: 0px; height: 48px;">CCTV 3</td>
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c3Obj" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c3Lev" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c3Loc" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
								</tr>
								<tr id="cctv4">
									<td id="c4Col1" style="text-align: center; width: 200px; padding-bottom: 0px; height: 48px;">CCTV 4</td>
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c4Obj" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c4Lev" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td style="width: 200px; height: 48px; padding: 0px; text-align: center;">
										<input id="c4Loc" value="*** 탐지 X ***" class="detectContent" readonly="readonly" style="width: 200px; height: 48px; padding-left: 0px"></td>
								</tr>
							</tbody>
						</table>
					</div>
