...
<html>
	...
	<script>
			...
			function sendJet(data) {
				...
				message = new Paho.MQTT.Message(orderData.zone);
				//console.log(message);
				message.destinationName = "/3manual/" + orderData.zone;
				client.send(message);
			...
			nowzone = {"1jetracer":"X", "2jetracer":"X", "3jetracer":"X"};
			...
			function onMessageArrived(message) {
				if(message.destinationName =="/mirror") {
	 			...
	 			if(message.destinationName =="/req/1jetracer") {
					...
					else if(obj.Class.includes("B")&&nowzone["1jetracer"]!="B"){
				        	carposition.x= 394;
				        	carposition.y= 50;
				        	carposition.angle= -Math.PI/2;
				        	nowzone["1jetracer"]="B";
				    }
					else if(obj.Class.includes("C")&&nowzone["1jetracer"]!="C"){
				        	carposition.x= 309;
				        	carposition.y= 50;
				        	carposition.angle= -Math.PI/2;
				        	nowzone["1jetracer"]="C";
				    }
					else if(obj.Class.includes("D")&&nowzone["1jetracer"]!="D"){
				        	carposition.x= 224;
				        	carposition.y= 50;
				        	carposition.angle= -Math.PI/2;
				        	nowzone["1jetracer"]="D";
				    }
					else if(obj.Class.includes("E")&&nowzone["1jetracer"]!="E"){
				        	carposition.x= 144;
				        	carposition.y= 50;
				        	carposition.angle= -Math.PI/2;
				        	nowzone["1jetracer"]="E";
				    }
					else if(obj.Class.includes("F")&&nowzone["1jetracer"]!="F"){
				        	carposition.x= 96;
				        	carposition.y= 96;
				        	carposition.angle= -Math.PI;
				        	nowzone["1jetracer"]="F";
				    }
					else if(obj.Class.includes("H")&&nowzone["1jetracer"]!="H"){
				        	carposition.x= 96;
				        	carposition.y= 162;
				        	carposition.angle= -Math.PI;
				        	nowzone["1jetracer"]="H";
				    }
					else if(obj.Class.includes("I")&&nowzone["1jetracer"]!="I"){
				        	carposition.x= 50;
				        	carposition.y= 305;
				        	carposition.angle= -Math.PI;
				        	nowzone["1jetracer"]="I";
				    }
					else if(obj.Class.includes("J")&&nowzone["1jetracer"]!="J"){
				        	carposition.x= 54;
				        	carposition.y= 354;
				        	carposition.angle= -Math.PI;
				        	nowzone["1jetracer"]="J";
				    }
					else if(obj.Class.includes("K")&&nowzone["1jetracer"]!="K"){
				        	carposition.x= 104;
				        	carposition.y= 404;
				        	carposition.angle= Math.PI/2;
				        	nowzone["1jetracer"]="K";
				    }
					else if(obj.Class.includes("M")&&nowzone["1jetracer"]!="M"){
				        	carposition.x= 156;
				        	carposition.y= 450;
				        	carposition.angle= Math.PI/2;
				        	nowzone["1jetracer"]="M";
				    }
					else if(obj.Class.includes("N")&&nowzone["1jetracer"]!="N"){
				        	carposition.x= 281;
				        	carposition.y= 450;
				        	carposition.angle= Math.PI/2;
				        	nowzone["1jetracer"]="N";
				    }
					else if(obj.Class.includes("P")&&nowzone["1jetracer"]!="P"){
				        	carposition.x= 450;
				        	carposition.y= 400;
				        	carposition.angle= 0;
				        	nowzone["1jetracer"]="P";
				    }
					else if(obj.Class.includes("S")&&nowzone["1jetracer"]!="S"){
				        	carposition.x= 450;
				        	carposition.y= 300;
				        	carposition.angle= 0;
				        	nowzone["1jetracer"]="S";
				    }
					else if(obj.Class.includes("T")&&nowzone["1jetracer"]!="T"){
							carposition.x= 450;
				        	carposition.y= 199;
				        	carposition.angle= 0;
				        	nowzone["1jetracer"]="T";
				...
				if(message.destinationName =="/req/2jetracer") {
					try{
						...
						//console.log("2jet이 연결됐지롱");
					
						response(1);
						lastSendtimearr[1] = Date.now();
	
						carposition = car2;
					 	if(obj.Class.includes("A")&&nowzone["2jetracer"]!="A"){
							carposition.x= 450;
				        	carposition.y= 94;
				        	carposition.angle= 0;
				        	nowzone["2jetracer"]="A";
						}
					 	else if(obj.Class.includes("B")&&nowzone["2jetracer"]!="B"){
				        	carposition.x= 394;
				        	carposition.y= 50;
				        	carposition.angle= -Math.PI/2;
				        	nowzone["2jetracer"]="B";
				        }
					 	else if(obj.Class.includes("C")&&nowzone["2jetracer"]!="C"){
				        	carposition.x= 309;
				        	carposition.y= 50;
				        	carposition.angle= -Math.PI/2;
				        	nowzone["2jetracer"]="C";
				        }
					 	else if(obj.Class.includes("D")&&nowzone["2jetracer"]!="D"){
				        	carposition.x= 224;
				        	carposition.y= 50;
				        	carposition.angle= -Math.PI/2;
				        	nowzone["2jetracer"]="D";
				        }
					 	else if(obj.Class.includes("E")&&nowzone["2jetracer"]!="E"){
				        	carposition.x= 144;
				        	carposition.y= 50;
				        	carposition.angle= -Math.PI/2;
				        	nowzone["2jetracer"]="E";
				        }
					 	else if(obj.Class.includes("F")&&nowzone["2jetracer"]!="F"){
				        	carposition.x= 96;
				        	carposition.y= 96;
				        	carposition.angle= -Math.PI;
				        	nowzone["2jetracer"]="F";
				        }
					 	else if(obj.Class.includes("H")&&nowzone["2jetracer"]!="H"){
				        	carposition.x= 96;
				        	carposition.y= 162;
				        	carposition.angle= -Math.PI;
				        	nowzone["2jetracer"]="H";
				        }
					 	else if(obj.Class.includes("I")&&nowzone["2jetracer"]!="I"){
				        	carposition.x= 50;
				        	carposition.y= 305;
				        	carposition.angle= -Math.PI;
				        	nowzone["2jetracer"]="I";
				        }
					 	else if(obj.Class.includes("J")&&nowzone["2jetracer"]!="J"){
				        	carposition.x= 54;
				        	carposition.y= 354;
				        	carposition.angle= -Math.PI;
				        	nowzone["2jetracer"]="J";
				        }
					 	else if(obj.Class.includes("K")&&nowzone["2jetracer"]!="K"){
				        	carposition.x= 104;
				        	carposition.y= 404;
				        	carposition.angle= Math.PI/2;
				        	nowzone["2jetracer"]="K";
				        }
					 	else if(obj.Class.includes("M")&&nowzone["2jetracer"]!="M"){
				        	carposition.x= 156;
				        	carposition.y= 450;
				        	carposition.angle= Math.PI/2;
				        	nowzone["2jetracer"]="M";
				        }
					 	else if(obj.Class.includes("N")&&nowzone["2jetracer"]!="N"){
				        	carposition.x= 281;
				        	carposition.y= 450;
				        	carposition.angle= Math.PI/2;
				        	nowzone["2jetracer"]="N";
				        }
					 	else if(obj.Class.includes("P")&&nowzone["2jetracer"]!="P"){
				        	carposition.x= 450;
				        	carposition.y= 400;
				        	carposition.angle= 0;
				        	nowzone["2jetracer"]="P";
				        }
					 	else if(obj.Class.includes("S")&&nowzone["2jetracer"]!="S"){
				        	carposition.x= 450;
				        	carposition.y= 300;
				        	carposition.angle= 0;
				        	nowzone["2jetracer"]="S";
				        }
					 	else if(obj.Class.includes("T")&&nowzone["2jetracer"]!="T"){
							carposition.x= 450;
				        	carposition.y= 199;
				        	carposition.angle= 0;
				        	nowzone["2jetracer"]="T";
				...
				if(message.destinationName =="/req/3jetracer") {
					try {
						...
						if(obj.success == "ok"){
						 ...
						 carposition = car3;
						 if(obj.Class.includes("A")&&nowzone["3jetracer"]!="A"){
								carposition.x= 450;
					        	carposition.y= 94;
					        	carposition.angle= 0;
					        	nowzone["3jetracer"]="A";
						  } else if(obj.Class.includes("B")&&nowzone["3jetracer"]!="B"){
					        	carposition.x= 394;
					        	carposition.y= 50;
					        	carposition.angle= -Math.PI/2;
					        	nowzone["3jetracer"]="B";
						  } else if(obj.Class.includes("C")&&nowzone["3jetracer"]!="C"){
					        	carposition.x= 309;
					        	carposition.y= 50;
					        	carposition.angle= -Math.PI/2;
					        	nowzone["3jetracer"]="C";
						  } else if(obj.Class.includes("D")&&nowzone["3jetracer"]!="D"){
					        	carposition.x= 224;
					        	carposition.y= 50;
					        	carposition.angle= -Math.PI/2;
					        	nowzone["3jetracer"]="D";
						  } else if(obj.Class.includes("E")&&nowzone["3jetracer"]!="E"){
					        	carposition.x= 144;
					        	carposition.y= 50;
					        	carposition.angle= -Math.PI/2;
					        	nowzone["3jetracer"]="E";
						  } else if(obj.Class.includes("F")&&nowzone["3jetracer"]!="F"){
					        	carposition.x= 96;
					        	carposition.y= 96;
					        	carposition.angle= -Math.PI;
					        	nowzone["3jetracer"]="F";
						  } else if(obj.Class.includes("H")&&nowzone["3jetracer"]!="H"){
					        	carposition.x= 96;
					        	carposition.y= 162;
					        	carposition.angle= -Math.PI;
					        	nowzone["3jetracer"]="H";
						  } else if(obj.Class.includes("I")&&nowzone["3jetracer"]!="I"){
					        	carposition.x= 50;
					        	carposition.y= 305;
					        	carposition.angle= -Math.PI;
					        	nowzone["3jetracer"]="I";
						  } else if(obj.Class.includes("J")&&nowzone["3jetracer"]!="J"){
					        	carposition.x= 54;
					        	carposition.y= 354;
					        	carposition.angle= -Math.PI;
					        	nowzone["3jetracer"]="J";
						  } else if(obj.Class.includes("K")&&nowzone["3jetracer"]!="K"){
					        	carposition.x= 104;
					        	carposition.y= 404;
					        	carposition.angle= Math.PI/2;
					        	nowzone["3jetracer"]="K";
						  } else if(obj.Class.includes("M")&&nowzone["3jetracer"]!="M"){
					        	carposition.x= 156;
					        	carposition.y= 450;
					        	carposition.angle= Math.PI/2;
					        	nowzone["3jetracer"]="M";
						  } else if(obj.Class.includes("N")&&nowzone["3jetracer"]!="N"){
					        	carposition.x= 281;
					        	carposition.y= 450;
					        	carposition.angle= Math.PI/2;
					        	nowzone["3jetracer"]="N";
						  } else if(obj.Class.includes("P")&&nowzone["3jetracer"]!="P"){
					        	carposition.x= 450;
					        	carposition.y= 400;
					        	carposition.angle= 0;
					        	nowzone["3jetracer"]="P";
						  } else if(obj.Class.includes("S")&&nowzone["3jetracer"]!="S"){
					        	carposition.x= 450;
					        	carposition.y= 300;
					        	carposition.angle= 0;
					        	nowzone["3jetracer"]="S";
						  } else if(obj.Class.includes("T")&&nowzone["3jetracer"]!="T"){
								carposition.x= 450;
					        	carposition.y= 199;
					        	carposition.angle= 0;
					        	nowzone["3jetracer"]="T";
		        ...
		        function updateGameArea() {
		           myGameArea.clear(); // 캔버스 지우기
		            ...
		            if(jetracer2connectedflag){car2.update();} // component 그리기
		            if(jetracer3connectedflag){car3.update();} // component 그리기
				...
				<div
					...
					<div class="navbar-header">
						<a href="${pageContext.request.contextPath}/home/main.do"
							...
							<div class="brand-text brand-big visible text-uppercase"
								...
								<strong class="text-primary">AIOT</strong><strong>Admin</strong>
							</div>
							<div class="brand-text brand-sm">
								<strong class="text-primary">A</strong><strong>A</strong>
							</div>
						</a>
					...
					<div class="right-menu list-inline no-margin-bottom">
						<div class="list-inline-item logout">
							<a id="logout"
								href="${pageContext.request.contextPath}/home/intro.do"
								class="nav-link"> <span class="d-none d-sm-inline">to
									INTRO </span><i class="icon-logout"></i></a>
						</div>
					</div>
				</div>
			</nav>
		...
		<div class="d-flex align-items-stretch" style="height: 875px;">
			<nav id="sidebar" style="height: 1030px;">
				<div class="sidebar-header d-flex align-items-center">
					<div class="avatar"
						style="width: 100px; height: 100px; align-itself: center;">
						<img src="${pageContext.request.contextPath}/resource/img/milk.jpg"
				...
				<ul class="list-unstyled">
					<li><a href="${pageContext.request.contextPath}/home/main.do"
					...
					<li><a
						href="${pageContext.request.contextPath}/home/history.do"
						style="color: lightgray"> <i class="icon-grid"></i>탐지 히스토리 조회
					</a></li>
					<li class="active"><a
						href="${pageContext.request.contextPath}/home/status.do"
						style="color: lightgray"> <i class="icon-padnote"></i>실시간 탐지 |
							대응 현황
					</a></li>
					<li><a
			...
			<div class="page-content"
				...
				<div
					style="margin-bottom: 10px; margin-top: 60px; color: white; font-weight: bold; font-size: xx-large; height: 50px; width: 1623px; text-align: center;">실시간
					유해동물 탐지 및 대응 현황</div>
	
				<section style="padding-right: 0px">
					<div class="container-fluid">
						<div class="container"
							style="position: absolute; margin-right: 0px; margin-left: 0px; width: 800px; height: 468px; top: 130px">
							<input value="CCTV 탐지 현황" readonly="readonly"
								style="background-color: #ADFF2F; color: black; font-weight: 500; font-size: 20px; border-color: transparent; font-weight: bold; width: 800px; text-align: center; margin-left: -15px" />
							<div class="row row-cols-2">
								<div class="col"
									style="padding-left: 0px; padding-right: 0px; width: 400px; height: 300px">
									<img id=cameraView1
										style="width: 400px; height: 300px; padding-left: 0px; padding-right: 0px; border: inactiveborder;" />
								</div>
								<div class="col"
									style="padding-left: 0px; padding-right: 0px; width: 400px; height: 300px">
									<img id=cameraView2
										style="width: 400px; height: 300px; padding-left: 0px; padding-right: 0px; borderstyle: none; bordercolor: transparent; borderwidth: inherit" />
								</div>
								<div class="col"
									style="padding-left: 0px; padding-right: 0px; width: 400px; height: 300px">
									<img id=cameraView3
				...
				<section style="padding-right: 0px">
					<div class="container-fluid">
						<div class="container"
							style="position: absolute; margin-right: 0px; margin-left: 800px; width: 750px; height: 468px; top: 130px;">
							<input value="현재 대응 중인 유해동물 탐지 위치" readonly="readonly"
								style="background-color: #864DD9; color: white; font-weight: 500; font-size: 20px; border-color: transparent; font-weight: bold; width: 750px; text-align: center;" />
							<div id="canvashere"
								style="background-color: transparent; width: 750px; height: 300px; color: white; text-align: center; font-size: xx-large; justify-content: center; border-color: #864DD9; border-style: solid; border-width: medium;"></div>
						</div>
					</div>
				</section>
	
				<input value="CCTV가 전송하는 유해동물 대응 미션 리스트" readonly="readonly"
					style="background-color: #864DD9; color: white; font-weight: 500; font-size: 20px; margin-left: 845px; border-color: transparent; font-weight: bold; position: absolute; margin-top: 360px; height: 36px; padding: 0px; text-align: center; width: 750px" />
	
				<div
					style="background-color: transparent; height: 500px; width: 750px; margin-top: 400px; margin-left: 845px; position: absolute">
	
					<div class="table-responsive"
						style="border-color: #864DD9; border-style: solid; border-width: medium; padding-left: 5px; padding-right: 5px; margin-top: -5px">
						<div id="animalTable"
							style="text-align: center; justify-content: center; height: 245px;">
							<table class="table table-striped table-sm"
								style="color: white; height: 245px">
								<thead
									style="border-style: double; border-left: hidden; border-right: hidden; border-top: hidden; border-color: #864DD9; font-size: medium;">
									<tr
										style="height: 40px; justify-content: center; padding: 0px; color: #864DD9; text-align: center;">
								...
								<tbody style="font-size: medium" id="detectedAnimal">
									<c:forEach var="animal" items="${animal}">
										<tr onclick="sendJet(this)">
											...
											<td>${animal.dzone}</td>
											<td><fmt:formatDate value="${animal.dtime}"
					...
					<div
						style="height: 280px; background-color: transparent; text-align: center; justify-content: center; margin-top: 15px; border-color: #864DD9; border-style: solid; border-width: medium;">
						<input value="CCTV에서 보낸 유해동물 대응 미션 현황" readonly="readonly"
							style="background-color: #864DD9; color: white; font-weight: 500; font-size: 20px; border: none; font-weight: bold; height: 36px; text-align: center; width: 750px; margin-top: -3px; margin-left: -3px" />
						<input id="numShow" value="사건 번호 000 대응 중" readonly="readonly"
							style="background-color: transparent; font-weight: bold; border-color: transparent; color: dimgray; text-align: center; margin-left: 30px; width: 200px; margin-top: 20px;">
						<input id="zoneShow" value="E 구역에서" readonly="readonly"
							style="background-color: transparent; font-weight: bold; border-color: transparent; color: dimgray; text-align: center; margin-left: 10px; width: 200px; margin-top: 20px">
						<input id="animalShow" value="고라니 탐지됨" readonly="readonly"
							style="background-color: transparent; font-weight: bold; border-color: transparent; color: dimgray; text-align: center; margin-left: 10px; width: 200px; margin-top: 20px">
	
						<img id="beginSign"
							src="${pageContext.request.contextPath}/resource/img/begin.png"
							style="width: 100px; height: 100px; margin-left: 40px; margin-top: 25px">
						<img id="startSign"
							src="${pageContext.request.contextPath}/resource/img/arrived.png"
							style="width: 100px; height: 100px; margin-left: 120px; margin-top: 25px">
						<img id="finishSign"
							src="${pageContext.request.contextPath}/resource/img/complete.png"
							style="width: 100px; height: 100px; margin-left: 110px; margin-top: 25px">
	
						<input id="beginText" value="A 구역 출동 중" readonly="readonly"
							style="background-color: transparent; font-weight: bold; border-color: transparent; color: dimgray; text-align: center; width: 200px; position: absolute; top: 480px; left: 80px">
						<input id="startText" value="도착 및 처리 중" readonly="readonly"
							style="background-color: transparent; font-weight: bold; border-color: transparent; color: dimgray; text-align: center; width: 200px; position: absolute; top: 480px; left: 300px">
						<input id="finishText" value="처리 완료" readonly="readonly"
							style="background-color: transparent; font-weight: bold; border-color: transparent; color: dimgray; text-align: center; width: 200px; position: absolute; top: 480px; left: 530px">
					</div>
				</div>
	
				<input value="유해동물 탐지 현황" readonly="readonly"
					style="background-color: #ADFF2F;; color: black; margin-left: 30px; font-weight: 500; font-size: 20px; border-color: transparent; font-weight: bold; position: absolute; margin-top: 660px; height: 36px; padding: 0px; text-align: center; width: 800px" />
	
				<div
					style="border-color: transparent; margin-top: 700px; width: 800px; margin-left: 5px">
					<div class="container"
						style="background-color: #22252a; border-color: #ADFF2F; border-style: solid; border-width: medium; width: 800px; margin-left: 25px">
						<table class="table hover" style="margin-bottom: 0px">
							<thead style="font-size: medium;">
								<tr>
									<th
										style="color: white; text-align: center; font-weight: bold; color: #ADFF2F; width: 150px; padding: 0px; height: 48px; justify-content: center;">탐지
										주체</th>
									<th
										style="color: white; text-align: center; font-weight: bold; color: #ADFF2F; width: 200px; padding: 0px; height: 48px; justify-content: center;">유해동물
										이름</th>
									<th
										style="color: white; text-align: center; font-weight: bold; color: #ADFF2F; width: 200px; padding: 0px; height: 48px; justify-content: center;">유해동물
										등급</th>
									<th
										style="color: white; text-align: center; font-weight: bold; color: #ADFF2F; width: 200px; padding: 0px; height: 48px; justify-content: center;">탐지
										구역</th>
								</tr>
							</thead>
							<tbody style="color: white; font-size: small;">
								<tr id="cctv1">
									<td id="c1Col1"
										style="text-align: center; width: 200px; padding-bottom: 0px; height: 48px; justify-content: center;">CCTV
										1</td>
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c1Obj" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c1Lev" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c1Loc" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
								</tr>
								<tr id="cctv2">
									<td id="c2Col1"
										style="text-align: center; width: 200px; padding-bottom: 0px; height: 48px;">CCTV
										2</td>
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c2Obj" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c2Lev" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c2Loc" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
								</tr>
								<tr id="cctv3">
									...
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c3Obj" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c3Lev" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c3Loc" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
								</tr>
								<tr id="cctv4">
									...
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c4Obj" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c4Lev" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
									<td
										style="width: 200px; height: 48px; padding: 0px; text-align: center;"><input
										id="c4Loc" value="*** 탐지 X ***" class="detectContent"
										readonly="readonly"
										style="width: 200px; height: 48px; padding-left: 0px"></td>
								</tr>
							</tbody>
