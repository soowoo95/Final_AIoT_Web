...
<html><head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/controlView/js/jquery.js"></script>    
    <script type="text/javascript" src="${pageContext.request.contextPath}/controlView/bootstrap/js/bootstrap.min.js"></script>

	<script type="text/javascript" src="${pageContext.request.contextPath}/controlView/js/lineandbars.js"></script>
    
	<script type="text/javascript" src="${pageContext.request.contextPath}/controlView/js/dash-charts.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/controlView/js/gauge.js"></script>
	
	<!-- NOTY JAVASCRIPT -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/controlView/js/noty/jquery.noty.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/controlView/js/noty/layouts/top.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/controlView/js/noty/layouts/topLeft.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/controlView/js/noty/layouts/topRight.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/controlView/js/noty/layouts/topCenter.js"></script>
	
	<!-- You can add more layouts if you want -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/controlView/js/noty/themes/default.js"></script>
    <!-- <script type="text/javascript" src="assets/js/dash-noty.js"></script> This is a Noty bubble when you init the theme-->
	<script type="text/javascript" src="http://code.highcharts.com/highcharts.js"></script>
	<script src="${pageContext.request.contextPath}/controlView/js/jquery.flexslider.js" type="text/javascript"></script>

    <script type="text/javascript" src="${pageContext.request.contextPath}/controlView/js/admin.js"></script>
    ...
    <div class="container">
      ...
      <!-- USER PROFILE BLOCK -->
        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
	      		...
	      		<hr>
				<div class="thumbnail">
					<img src="${pageContext.request.contextPath}/controlView/images/face80x80.jpg" alt="Marcel Newman" class="img-circle">
				</div><!-- /thumbnail -->
				<h1>Marcel Newman</h1>
				<h3>Madrid, Spain</h3>
				<br>
      ...
      <!-- SERVER UPTIME -->
			<div class="half-unit">
	      		...
	      		<hr>
	      		<div class="cont">
					<p><img src="${pageContext.request.contextPath}/controlView/images/up.png" alt=""> <bold>Up</bold> | 356ms.</p>
				</div>
			</div>
      		...
      		<div class="framemail">
    			<div class="window">
			        <ul class="mail">
			            ...
			            <li>
			                <i class="read"></i>
			                <img class="avatar" src="${pageContext.request.contextPath}/controlView/images/photo03.jpg" alt="avatar">
			            ...
			            <li>
			                <i class="read"></i>
			                <img class="avatar" src="${pageContext.request.contextPath}/controlView/images/photo04.jpg" alt="avatar">
        ...
        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
	            ...
	            <div class="flexslider">
					<ul class="slides">
						<li><img src="${pageContext.request.contextPath}/controlView/images/slide01.png" alt="slider"></li>
						<li><img src="${pageContext.request.contextPath}/controlView/images/slide02.png" alt="slider"></li>
					</ul>
            </div>
				<div class="cont">
	  ...
	  <!-- LIVE VISITORS BLOCK -->     
      		<div class="half-unit">
	      		...
	      		<div class="cont">
      			<p><bold>388</bold></p>
      			<p><img src="${pageContext.request.contextPath}/controlView/images/up-small.png" alt=""> 412 Max. | <img src="${pageContext.request.contextPath}/controlView/images/down-small.png" alt=""> 89 Min.</p>
	      		</div>
      		</div>
	  ...
	  <!-- PAGE VIEWS BLOCK -->     
      		<div class="half-unit">
      			...
      			<p><img src="${pageContext.request.contextPath}/controlView/images/up-small.png" alt=""> 23.88%</p>
	      		</div>
      		</div>
      	</div>
