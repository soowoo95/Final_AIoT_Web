...
<html>
  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          <div class="avatar"><img src="https://d19m59y37dris4.cloudfront.net/dark-admin/1-4-6/img/avatar-6.jpg" alt="..." class="img-fluid rounded-circle"></div>
          <div class="title">
    ...
    <div id="style-switch" class="collapse">
      ...
      <p><img src="https://d19m59y37dris4.cloudfront.net/dark-admin/1-4-6/img/template-mac.png" alt="" class="img-fluid"></p>
      ...
      <p>Do you want more components or SCSS sources?</p>
      <p> <a href="https://bootstrapious.com/p/bootstrap-4-dark-admin-premium" class="btn btn-primary">Get Premium version</a></p>
    </div>
    <!-- JavaScript files-->
    ...
    <script src="https://d19m59y37dris4.cloudfront.net/dark-admin/1-4-6/js/charts-custom.js"></script>
