      ...
      <nav id="sidebar" style="height: 1030px;">
        ...
        <ul class="list-unstyled">
          <li><a href="${pageContext.request.contextPath}/home/main.do" style="color: lightgray"> <i class="icon-home"></i>메인 페이지</a></li>
	          ...
	          <li  class="active"><a href="${pageContext.request.contextPath}/home/jetson1.do" style="color: lightgray;text-align: right;">   1번탐지봇 현황 </a></li>
	      	  <li><a href="${pageContext.request.contextPath}/home/jetson2.do" style="color: lightgray;text-align: right;">   2번탐지봇 현황 </a></li>
...
function manual(value){
	...
	if (value == 'On'){
		...
		$("#jet-racer").keydown(function(event) {
			if (event.keyCode == '38') {
			  	console.log("달리자3")
