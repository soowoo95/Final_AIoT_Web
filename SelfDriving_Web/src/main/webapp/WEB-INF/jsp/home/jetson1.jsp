			...
			<div
				...
				<div class="navbar-header">
					<a href="${pageContext.request.contextPath}/home/main.do"
						class="navbar-brand">
						<div class="brand-text brand-big visible text-uppercase"style="font-size: x-large">
	...
	<div class="d-flex align-items-stretch" style="height: 875px;">
		...
		<nav id="sidebar" style="height: 1030px;">
			...
			<ul class="list-unstyled">
				...
				<li class="active"><a
					href="${pageContext.request.contextPath}/home/jetson1.do"
					style="color: lightgray; text-align: right;"> 1번탐지봇 현황 </a></li>
				<li><a
					href="${pageContext.request.contextPath}/home/jetson2.do"
					style="color: lightgray; text-align: right;"> 2번탐지봇 현황 </a></li>
				<li><a
					href="${pageContext.request.contextPath}/home/jetson3.do"
					style="color: lightgray; text-align: right;"> 3번탐지봇 현황 </a></li>
				<li><a
					href="${pageContext.request.contextPath}/home/history.do"
					style="color: lightgray"> <i class="icon-grid"></i>탐지 히스토리 조회
				</a></li>
				<li><a href="${pageContext.request.contextPath}/home/status.do"
		...
		<div class="page-content"
			...
			<div id="leftmenu">
				...
				</span> <br /> <span class="menuitem entypo-chart-area">
					<p id="ram" class="caption">MQTT: Wifi</p>
				</span> <br /> <span class="menuitem entypo-chart-pie">
			...
			<article>
				<div id="rightmenu">
					<p id="headline" class="title"
						style="text-align: left; margin-left: 10px; display: none;">Detection
						Object List</p>
					<div id="text">
						<div id="checkelement">
							<img id="textboximg"
								src="${pageContext.request.contextPath}/resource/img/도로사진/admin2.png">
					...
					<div class="row" style="width: 320px; height: 200px">
						<div class="col-md-3 col-sm-6" style="padding: 0px; height: 170px">
							<div class="statistic-block block"
								style="justify-content: center; padding: 0px; width: 320px; margin-bottom: 10px">
								<div class="progress-details d-flex align-items-end justify-content-between"
									style="justify-content: center; height: 80px; padding: 0px">
							...
							<div class="statistic-block block"style="justify-content: center; padding: 0px; width: 320px">
								<div class="progress-details d-flex align-items-end justify-content-between"style="justify-content: center; height: 80px">
									<div class="title"style="justify-content: center; margin: 15px">
										...
										<strong style="color: white">Target Action</strong>
									</div>
									<div id="targetSpeed2"
										style="color: #864DD9; font-size: x-large; font-weight: bold;; margin-right: 15px; margin-bottom: 15px">
										Speed : ---</div>
								</div>
							</div>
						</div>
			...
			<div id="batteryMode" style="background-color: #864DD9; width: 320px; color: white; font-weight: bold; justify-content: center; position: absolute; left: 1260px; top: 820px">
				<div style="width: 320px">
					<input id="modeOn1" onclick="manual1('On')" value="Manual Driving"readonly="readonly"style="border-color: transparent; width: 140px; background-color: dimgray; text-align: center; color: white; font-weight: bold; justify-content: center;">
					<input id="modeOff1" onclick="manual1('Off')" value="Auto Driving"readonly="readonly"style="border-color: transparent; width: 140px; background-color: #ADFF2F; text-align: center; color: black; font-weight: bold; justify-content: center; margin-left: 35px">
				</div>
			</div>

			<div id="manual_control1"style="display: none; width: 380px; height: 200px; position: absolute; top: 840px;">
				<div style="margin-left: 1170px; width: 320px; height: 200px; position: absolute" align="center">
					...
					<a class="btn btn-outline-warning btn-sm manual-line"onclick="manual('W')" style="color: black">L Line</a> <aclass="btn btn-outline-warning btn-sm manual-line"onclick="manual('W')" style="color: black">R Line</a>
				</div>
			</div>
			<!-- Map canvas box -->
...
/* 		$(function(){
		...
		function manual1(value) {
			...
			if (value == 'On') {
				...
				document.getElementById('modeOn1').style.color = 'black';
				document.getElementById('modeOff1').style.backgroundColor = 'dimgray';
				document.getElementById('modeOff1').style.color = 'white';
				document.getElementById('manual_control1').style.display = 'block';
				...
				document.getElementById('modeOff1').style.backgroundColor = '#ADFF2F';
				document.getElementById('modeOff1').style.color = 'black';
				document.getElementById('manual_control1').style.display = 'none';
						...
						if (changenum != name) {
							if (name.length == 1) {
								...
								$("#textboximg").css("box-shadow",
										"0 0 10px #FF3535, 0 0 10px #FF3535");
								$("#textboximg").css("border",
										"3px solid #FF3535");
								if (name == "A") {
		...
		function WordShuffler(holder, opt) {
			...
			this.updateCharacter = function(time) {
				...
				if (this.delta > this.interval) {
					...
					for (var i = 0; i < this.currentWordLength
							- this.currentCharacter; i++) {
						word.push(this.getRandCharacter(this.currentWord[this.currentCharacter+ i]));
					}

					if (that.useCanvas) {
						c.clearRect(0, 0, stage.x * stage.dpr, stage.y
								* stage.dpr);
						...
						word.forEach(function(w, index) {
							...
							c.fillText(w, that.position.x + spacing,
									that.position.y);
						...
						word.forEach(function(w, index) {
							...
							that.holder.appendChild(that
									.generateSingleCharacter(color, w));
						});
					}
