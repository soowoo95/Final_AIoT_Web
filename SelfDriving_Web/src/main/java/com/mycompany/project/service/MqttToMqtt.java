...
import com.mycompany.project.controller.AnimalController;

@Service
public class MqttToMqtt implements MqttCallback{
	private static final Logger LOGGER = LoggerFactory.getLogger(MqttToMqtt.class);
	...
	public void chogihwa(String broker, String client_id,String username, String passwd, MQTT recvMQTT){
		this.Broker = broker;
